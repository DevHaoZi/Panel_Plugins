...
app('router')->group([
    ...
    Route::get('cleanErrorLog', [Php80Controller::class, 'cleanErrorLog']);
    Route::get('cleanSlowLog', [Php80Controller::class, 'cleanSlowLog']);
    Route::get('restart', [Php80Controller::class, 'restart']);
    Route::get('reload', [Php80Controller::class, 'reload']);
